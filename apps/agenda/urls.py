...
urlpatterns = [
    ...
    path("novo/", views.agenda_criar, name="criar"),
    path("<int:pk>/editar/", views.agenda_editar, name="editar"),
    path("followup/", views.agenda_followup, name="followup"),
    path("<int:pk>/confirmar/", views.agenda_toggle_confirmacao, name="toggle_confirmacao"),
    path("<int:pk>/enviar-mensagem/", views.agenda_enviar_mensagem, name="enviar_mensagem"),
